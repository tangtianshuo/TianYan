  ...
  <div class="wrapper">
    <div class="toolbar">
      <div class="left">
        ...
        <button class="btn" @click="handlePrint">输出</button>
      </div>
      <div class="right">
        <select v-model="formCategory" class="select">
          <option value="">未分类</option>
          <option value="personal">个人</option>
          <option value="work">工作</option>
          <option value="other">其他</option>
        </select>
        <input v-model="formName" type="text" class="input" placeholder="配置名称" />
      </div>
    </div>
    ...
    <div class="grid-box">
      <div class="grid">
        <BaguaCell
          ...
          @update="(index, value, label) => onUpdate(cell.cellId, index, value, label)"
        />
      </div>
    </div>
  </div>
...
const onUpdate = (cellId: string, dropdownIndex: number, value: string | null, label: string | null): void => {
